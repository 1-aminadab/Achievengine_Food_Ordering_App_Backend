...
exports.seedPromoCodeData = exports.seedFoodData = void 0;
...
const seedFoodData = async () => {
    try {
        const existingFoods = await Food_1.default.countDocuments();
        if (existingFoods > 0) {
        ...
        await Food_1.default.insertMany(sampleFoods);
...
exports.seedFoodData = seedFoodData;
const seedPromoCodeData = async () => {
    try {
        const existingPromoCodes = await PromoCode_1.default.countDocuments();
        ...
        await PromoCode_1.default.insertMany(samplePromoCodes);
...
exports.seedPromoCodeData = seedPromoCodeData;
